...
export default function MyEnrollmentsPage() {
  ...
  async function fetchEnrollments() {
    try {
      ...
      // Deduplicate enrollments by program to avoid duplicate cards that block access
      ...
      const uniqueEnrollments = [...enrollmentMap.values(), ...enrollmentsWithoutProgram].sort((a, b) => {
