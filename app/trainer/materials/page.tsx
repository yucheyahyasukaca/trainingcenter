    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-orange-50 to-amber-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-6">
          ...
          <p className="text-gray-600 mb-6 text-lg">Silakan login untuk mengakses materi pembelajaran!</p>
          <p className="text-gray-500 text-sm mb-8">Kita siapkan konten terbaik untuk pembelajaran! 🎯</p>
          <a 
            href="/login" 
