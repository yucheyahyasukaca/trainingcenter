-- ============================================================================
-- FIX REFERRAL POLICY SYSTEM - SIMPLIFIED VERSION
-- ============================================================================

-- Drop existing functions if they exist
DROP FUNCTION IF EXISTS create_referral_policy(UUID, UUID, DECIMAL, DECIMAL, VARCHAR, DECIMAL, DECIMAL, VARCHAR, INTEGER, INTEGER, TIMESTAMP WITH TIME ZONE);
DROP FUNCTION IF EXISTS create_referral_code_with_policy(UUID, VARCHAR, UUID, TEXT, INTEGER, TIMESTAMP WITH TIME ZONE);
DROP FUNCTION IF EXISTS apply_referral_code_with_policy(VARCHAR, UUID, UUID, UUID, UUID);
...
-- Hapus kolom diskon dan komisi dari referral_codes jika ada
...
-- ============================================================================
-- STEP 3: CREATE FUNCTIONS (FIXED)
-- ============================================================================

-- Function untuk membuat policy referral (FIXED parameter order)
...
-- ============================================================================
-- STEP 6: INSERT SAMPLE DATA (COMMENTED OUT)
-- ============================================================================

-- Sample policy untuk program (admin set)
-- Uncomment dan sesuaikan dengan data yang ada
/*
INSERT INTO referral_policies (
    program_id,
    participant_discount_percentage,
