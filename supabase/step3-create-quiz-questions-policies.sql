-- =====================================================
-- STEP 3: CREATE QUIZ QUESTIONS POLICIES
-- =====================================================
-- Jalankan script ini setelah Step 2 berhasil
-- =====================================================

-- Policy 1: Admin and assigned trainers manage quiz questions
...
-- Policy 2: Users can view quiz questions for enrolled classes
