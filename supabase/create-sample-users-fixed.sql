-- ========================================
-- CREATE SAMPLE USERS untuk GARUDA-21 Training Center (FIXED VERSION)
-- ========================================
-- Jalankan SQL ini di Supabase SQL Editor setelah auth-setup.sql
-- Fixed: Removed generated columns yang tidak bisa di-insert manual

-- Method: Insert langsung ke auth.users (Development only)
...
-- Test authentication (akan return user data jika berhasil)
