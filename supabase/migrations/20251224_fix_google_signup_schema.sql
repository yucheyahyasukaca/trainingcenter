-- Fix for Google Signup Failure
-- 1. Ensure avatar_url column exists in user_profiles
DO $$
BEGIN
...
-- 2. Update function to handle new user signup (safely handling nulls)
...
-- 3. Ensure Trigger is properly set
