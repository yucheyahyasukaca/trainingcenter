-- Forum Setup WITHOUT RLS - For testing purposes
-- This creates forum tables without Row Level Security
...
-- 7. Create simple function to increment view count
...
-- 8. Disable RLS on all forum tables (for testing)
